...
public class Client {
	...
	public static void fileRead(String name) throws MalformedURLException, UnsupportedEncodingException, IOException{
		...
		while(inFile.ready()){
			...
			i++;
			if(i == 200){
				InputStream input = new URL(url.substring(0, url.length()) + "&f=nsocghjkr").openStream();
				changed = new InputStreamReader(input, "UTF-8");
			    ...
			    while ((nextLine = reader.readNext()) != null) {
			        System.out.println("\nCompany: " + nextLine[0] + "(" + nextLine[1] + ")\n");
			        System.out.println("\tOpen: " + nextLine[2]);
			        System.out.println("\tChange: " + nextLine[3]);
			        System.out.println("\tDay's Low: " + nextLine[4]);
			        System.out.println("\tDay's High: " + nextLine[5]);
			        System.out.println("\t52 Week Low: " + nextLine[6]);
			        System.out.println("\t52 Week High: " + nextLine[7]);
			        System.out.println("\tP/E Ratio: " + nextLine[8]);
			    }
